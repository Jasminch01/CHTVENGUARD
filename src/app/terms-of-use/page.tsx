      ...
      <div className="prose prose-lg max-w-none space-y-3">
        <section>
          ...
          <p className="dark:text-gray-500">
            ...
            CHTVANGUARD’s Privacy Policy. However, if anyone has any objection or
            ...
            sending an email at: [info@chtvanguard.com@gmail.com]. But the authority of
        ...
        <section>
          ...
          <p className="dark:text-gray-500">
            ...
            name belong to CHTVANGUARD. Users cannot claim any rights in CHTVANGUARD’S intellectual property whether for commercial or
            non-commercial use. In addition, users are prevented from making any
            derivative work from the content of CHTVANGUARD.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="dark:text-gray-500">
            ...
            content from their respective devices if asked by CHTVANGUARD.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="dark:text-gray-500">
            ...
            reputation. The user is also prohibited from defaming CHTVANGUARD.
        ...
        <section>
          ...
          <p className="dark:text-gray-500">
            ...
            published or generated by CHTVANGUARD.
          </p>
        </section>
      </div>
    </div>
